...
type User struct {
	...
	CreatedAtTimestamp uint64                 `protobuf:"varint,5,opt,name=created_at_timestamp,json=createdAtTimestamp,proto3" json:"created_at_timestamp,omitempty"`
...
func (x *User) GetCreatedAtTimestamp() uint64 {
	if x != nil {
...
const file_user_proto_rawDesc = "" +
	...
	"\rpassword_hash\x18\x04 \x01(\tR\fpasswordHash\x120\n" +
	"\x14created_at_timestamp\x18\x05 \x01(\x04R\x12createdAtTimestampB&Z$github.com/pythonsogood/ap/in3/protob\x06proto3"
